    ...
    <div className="min-h-screen bg-gradient-to-b from-[#FAF8F3] to-white">
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-8 pb-24">
        <div className="bg-white rounded-2xl shadow-lg p-8 lg:p-12 space-y-8 text-lg text-gray-700 leading-relaxed">
          ...
          <p className="text-justify">
            "This House believes AI is eroding human agency" was the motion put to the debate that afternoon. True to Cambridge Union tradition, the audience cast its votes by leaving through the AYES or NOES doors, with votes counted both before and after the debate to measure the swing in opinion. I was firmly on Professor Yvonne Rogers FRS's side, and walked out through the Noes door along with the majority: the Noes won, with Professor Yvonne Rogers achieving the larger swing in support, a genuinely persuasive demonstration, in the room, that AI can strengthen rather than diminish human agency when it is designed and governed responsibly. Sitting in that chamber, watching a debate decided the same way generations of Cambridge Union debates have been decided before it, was a reminder of exactly why this venue was the right place to be asking the question.
          </p>
