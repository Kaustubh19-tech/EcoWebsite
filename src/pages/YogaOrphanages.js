            ...
            <div className="max-w-6xl mx-auto px-6 lg:px-8 pb-24">
                ...
                <div className="mb-12">
                    ...
                    <p className="text-center text-gray-500 text-sm mt-6 italic">
                        Sessions conducted during June-July 2019 • Early morning yoga classes at orphanage, Nagpur
                    </p>
                </div>
